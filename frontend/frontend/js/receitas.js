// ===== FINPESSOAL – RECEITAS JS v4 =====
// Lista TODAS as receitas. Total calculado sobre o mês global selecionado.
...
async function popularSelectsReceitas() {
  ...
  if (selRec) selRec.innerHTML = opts || '<option>Sem categorias</option>';
  if (selRp)  selRp.innerHTML  = opts || '<option>Sem categorias</option>';
}
...
async function carregarReceitas() {
  // Busca TODAS as receitas (sem filtro de mês)
...
// Calcula total apenas do mês/ano global e atualiza o card
