...
// ── Carrega dados do mês/ano vindos do estado global ──────────────
...
// ── Init ──────────────────────────────────────────────────────────
// app.js DOMContentLoaded já chama verificarAuth, exibirSaudacao,
// renderizarSidebarUser e preencherFiltros (selects do topbar desktop).
// Aqui registramos o seletor mobile na sidebar e carregamos os dados.
document.addEventListener('DOMContentLoaded', () => {
  // Injeta seletor de mês na sidebar (visível somente no mobile via CSS)
  renderizarSidebarMesSel(carregarDados);
  // Carrega dados com o mês do estado global (sessionStorage ou data atual)
