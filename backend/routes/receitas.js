...
router.post('/', autenticar, async (req, res) => {
  const { descricao, valor, categoria, mes, ano } = req.body;
  ...
  try {
    const result = await pool.query(
      'INSERT INTO receitas (usuario_id, descricao, valor, categoria, mes, ano) VALUES ($1,$2,$3,$4,$5,$6) RETURNING *',
      [req.usuario.id, descricao, valor, categoria, mes, ano]
    );
...
// Resumo anual de receitas por categoria
